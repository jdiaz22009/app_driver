...
export class FindFreightDriverPage {
  ...
  shared(freight){
    ...
    const message = `No DE PEDIDO: ${freight.pedido}. Ruta: ${freight.ciudad_origen}-${freight.ciudad_destino}. Vehículo: ${freight.clase_vehiculo}-${freight.tipo_carroceria}. Peso: ${freight.peso_carga_max} TON. CONTACTO: ${freight.coordinador.primer_nombre} ${freight.coordinador.primer_apellido}, ${freight.coordinador.celular}, Si quieres pago contra entrega, pregunta por PagaYa!!! http://tiny.cc/u09z5y`
